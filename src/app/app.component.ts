...
export class AppComponent {
  ...
  meanings = [
    ...
    "overshadow, outshine",
    "feeling or expressing overwhelming happiness or oyful excitement; enraptured.",
    ...
    "characterized by or feeling intense excitement and happiness; elation.",
    ...
    "pressing; demanding; requiring immediate attention; urgent or critical.",
    "<span>1.originating in or characteristic of a distant foreign country.</span></br><span>2.attractive or striking because colorful or out of the ordinary.</span>",
    "a means of attaining an end, especially one that is convenient but considered improper or immoral.",
    "stated clearly and in detail, leaving no room for confusion or doubt; without equivocation.",
    ...
    "not having any serious purpose or value; trivial or silly.",
  ...
  wordObj = {
    ...
    "Ecstatic": "feeling or expressing overwhelming happiness or oyful excitement; enraptured.",
    ...
    "Euphoric": "characterized by or feeling intense excitement and happiness; elation.",
    ...
    "Exigent": "pressing; demanding; requiring immediate attention; urgent or critical.",
    "Exotic": "<span>1. originating in or characteristic of a distant foreign country.</span></br><span>2. attractive or striking because colorful or out of the ordinary.</span>",
    "Expedient": "a means of attaining an end, especially one that is convenient but considered improper or immoral.",
    "Explicit": "stated clearly and in detail, leaving no room for confusion or doubt; without equivocation.",
    ...
    "Frivolous": "not having any serious purpose or value; trivial or silly.",
